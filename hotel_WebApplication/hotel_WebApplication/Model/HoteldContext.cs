...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CommHotel>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCommNavigation).WithMany(p => p.CommHotels)
        ...
        {
            entity.HasKey(e => e.IdguestBook).HasName("PRIMARY");

            entity.ToTable("guest_book");

            entity.HasIndex(e => e.GuestId, "guestid_idx");

            entity.HasIndex(e => e.Bookid, "idbook_idx");

            entity.Property(e => e.IdguestBook).HasColumnName("idguest_book");
            entity.Property(e => e.Bookid).HasColumnName("bookid");
            entity.Property(e => e.GuestId).HasColumnName("guest_id");

            entity.HasOne(d => d.Book).WithMany(p => p.GuestBooks)
                .HasForeignKey(d => d.Bookid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("idbook");

            entity.HasOne(d => d.Guest).WithMany(p => p.GuestBooks)
