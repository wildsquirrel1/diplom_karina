...
CREATE TABLE `status_room` (
  `idstatus_room` int NOT NULL AUTO_INCREMENT,
  `name` varchar(70) NOT NULL,
  PRIMARY KEY (`idstatus_room`)
...
INSERT INTO `status_room` VALUES (1,'Занят'),(2,'Свободен'),(3,'Грязный'),(4,'На уборке'),(5,'Заблокирован');
